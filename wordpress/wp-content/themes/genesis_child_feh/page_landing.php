 ...
 * feh Pro.
 *
 * This file adds the landing page template to the feh Pro Theme.
 *
...
add_filter( 'body_class', 'feh_add_body_class' );
/**
 ...
 */
function feh_add_body_class( $classes ) {
...
add_action( 'wp_enqueue_scripts', 'feh_dequeue_skip_links' );
/**
 * Dequeues the skip links script.
 *
 * @since 1.0.0
 */
function feh_dequeue_skip_links() {
...
remove_action( 'genesis_before_header', 'feh_before_header' );
